...
<body>
    ...
    <div class="search-input">
        <i class="fa-regular fa-folder-open" onclick="document.getElementById('fileUpload').click()" style="cursor:pointer;"></i>
<input type="file" id="fileUpload" style="display:none;" accept=".pdf,.doc,.docx">
